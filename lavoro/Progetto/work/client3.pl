...
evi(richiesta_ticket):-write('SALVE, MI SERVIREBBE IL TICKET PER EFFETTUARE UNA OPERAZIONE BANCARIA'),nl,a(message(ticket,send_message(richiede_ticket(var_Me,cliente3),var_Me))).
