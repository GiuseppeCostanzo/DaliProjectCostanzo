...
evi(scelta_operazione(var_Operazione)):-random(1,3,var_Operazione),(var_Operazione==1->var_OperazioneScelta=prelievo;var_Operazione==2->var_OperazioneScelta=pagamento;var_Operazione==3->var_OperazioneScelta=deposito),write('Salve dovrei effettuare una operazione di: '),write(var_OperazioneScelta),nl.
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_312751,var_Ontology,_312755),_312745),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_312789)),a(message(var_Ag,propose(var_A,[_312789],var_AgI))),retractall(ext_agent(var_Ag,_312827,var_Ontology,_312831)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_312625,var_Ontology,_312629),_312619),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_312695,var_Ontology,_312699)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_312513,var_Ontology,_312517),_312507),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_312569,var_Ontology,_312573)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_312077),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_312111),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_311893).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_311741),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_311689),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_311565,_311567)),clause(agente(_311587,_311589,_311591,var_S),_311583),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_311359,_311361,_311363,var_S),_311355),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_311459,[]),repeat,read(_311459,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_311459).
